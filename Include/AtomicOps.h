...
#define __InterlockedReadPointer(lpValue) ((LPVOID)_InterlockedExchangeAdd((LONG volatile *)lpValue, 0L))
...
#define __InterlockedCompareExchangePointer(lpValue, lpExchange, lpComperand)                                          \
    ((LPVOID)_InterlockedCompareExchange((LONG volatile *)lpValue, (LONG)lpExchange, PtrToLong(lpComperand)))

#elif defined(_M_X64)

#define __InterlockedReadPointer(lpValue) ((LPVOID)_InterlockedExchangeAdd64((__int64 volatile *)lpValue, 0i64))
#define __InterlockedExchangePointer(lpValue, lpPtr)                                                                   \
    ((LPVOID)_InterlockedExchange64((__int64 volatile *)lpValue, (__int64)lpPtr))
#define __InterlockedCompareExchangePointer(lpValue, lpExchange, lpComperand)                                          \
    ((LPVOID)_InterlockedCompareExchange64((__int64 volatile *)lpValue, (__int64)lpExchange, (__int64)lpComperand))

#endif

#define __InterlockedReadSizeT(lpnValue) ((SIZE_T)__InterlockedReadPointer((LPVOID volatile *)lpnValue))
...
#define __InterlockedCompareExchangeSizeT(lpnValue, nExchange, nComperand)                                             \
    ((SIZE_T)__InterlockedCompareExchangePointer((LPVOID volatile *)lpnValue, (LPVOID)nExchange, (LPVOID)nComperand))
