  ...
  public:
    class CClientRequest : public CIpc::CUserData
    {
      ...
      public:
        ...
        template <class T> T *GetRequestHeader() const
        {
        ...
        template <class T> HRESULT AddResponseHeader(_Out_ T **lplpHeader = NULL)
        {
        ...
        template <class T> T *GetResponseHeader() const
        {
...
inline CHttpServer::CClientRequest::eTimeoutTimer operator|(CHttpServer::CClientRequest::eTimeoutTimer lhs,
                                                            CHttpServer::CClientRequest::eTimeoutTimer rhs)
{
