...
class MX_NOVTABLE CIpc : public virtual CBaseMemObj, public CLoggable
{
  ...
  public:
    ...
    typedef Callback<VOID(_In_ CIpc *lpIpc, _In_ HANDLE h, _In_ CUserData *lpUserData, _In_ HRESULT hrErrorCode)>
        OnDisconnectCallback;
    typedef Callback<HRESULT(_In_ CIpc *lpIpc, _In_ HANDLE h, _In_ CUserData *lpUserData)> OnDataReceivedCallback;
    typedef Callback<VOID(_In_ CIpc *lpIpc, _In_ HANDLE h, _In_ CUserData *lpUserData, _In_ HRESULT hrErrorCode)>
        OnDestroyCallback;

    typedef Callback<VOID(_In_ CIpc *lpIpc, _In_ HANDLE h, _In_ LPVOID lpCookie, _In_ CUserData *lpUserData)>
        OnAfterWriteSignalCallback;
