...
int StrNCompareAW(_In_z_ LPCSTR szSrcA1, _In_z_ LPCWSTR szSrcW2, _In_ SIZE_T nLen, _In_opt_ BOOL bCaseInsensitive)
{
...
VOID CStringA::Delete(_In_ SIZE_T nStartChar, _In_ SIZE_T nChars)
{
    ...
    if (nLen > 0)
    {
        ...
        if (nStartChar + nChars > nLen || nStartChar + nChars < nStartChar)
        { // overflow
