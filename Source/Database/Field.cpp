...
template <> inline bool isNan(_In_ double value)
{
    return _isnan(value);
}

template <typename T> static T getSign(_In_ T value)
{
...
template <typename fromType, typename toType> static bool convertNumber(_In_ fromType n, _Out_ toType *lpRes)
{
