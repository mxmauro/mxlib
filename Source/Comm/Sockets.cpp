...
CSockets::CConnection::CConnection(_In_ CIpc *lpIpc, _In_ CIpc::eConnectionClass nClass, _In_ eFamily _nFamily)
    : CConnectionBase(lpIpc, nClass), CNonCopyableObj(), nFamily(_nFamily)
{
    ;
...
HRESULT CSockets::CConnection::SetupListener()
{
    ...
    if (sAddr.si_family == AF_INET6 && sAddr.Ipv6.sin6_addr.u.Word[0] == 0 && sAddr.Ipv6.sin6_addr.u.Word[1] == 0 &&
