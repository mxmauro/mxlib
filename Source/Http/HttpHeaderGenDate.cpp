...
HRESULT CHttpHeaderGenDate::Parse(_In_z_ LPCSTR szValueA, _In_opt_ SIZE_T nValueLen)
{
  LPCSTR szValueEndA;
  HRESULT hRes;
...
HRESULT CHttpHeaderGenDate::Build(_Inout_ CStringA &cStrDestA, _In_ Http::eBrowser nBrowser)
{
